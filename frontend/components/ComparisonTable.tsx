...
export default function ComparisonTable({ services }: Props) {
  ...
  return (
    <div className="mt-10 w-full overflow-x-auto rounded-3xl border border-gray-200 bg-white shadow-lg transition-all duration-300 dark:border-slate-700 dark:bg-slate-800">
      <h2 className="border-b border-gray-200 px-6 py-5 text-center text-3xl font-bold text-gray-900 dark:border-slate-700 dark:text-white">
